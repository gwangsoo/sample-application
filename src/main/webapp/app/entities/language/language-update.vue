  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="tossApp.language.home.createOrEditLabel"
          data-cy="LanguageCreateUpdateHeading"
          v-text="t$('tossApp.language.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('tossApp.language.name')" for="language-name"></label>
            <input
              type="text"
              class="form-control"
              name="name"
