...
/**
 * REST controller for managing {@link com.phoenixdarts.toss.backend.domain.Role}.
 */
@RestController
...
public class RoleResource {
    ...
    public ResponseEntity<RoleDTO> createRole(@Valid @RequestBody RoleDTO roleDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/roles/" + roleDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, roleDTO.getId()))
            .body(roleDTO);
    }
    ...
    public ResponseEntity<RoleDTO> updateRole(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, roleDTO.getId()))
            .body(roleDTO);
    }
    ...
    public ResponseEntity<RoleDTO> partialUpdateRole(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, roleDTO.getId()));
    }
