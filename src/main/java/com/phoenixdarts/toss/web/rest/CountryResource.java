...
import com.phoenixdarts.toss.repository.CountryRepository;
import com.phoenixdarts.toss.service.CountryService;
...
/**
 * REST controller for managing {@link com.phoenixdarts.toss.domain.Country}.
 */
@RestController
...
public class CountryResource {
    ...
    public ResponseEntity<CountryDTO> createCountry(@Valid @RequestBody CountryDTO countryDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/countries/" + countryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, countryDTO.getId()))
            .body(countryDTO);
    }
