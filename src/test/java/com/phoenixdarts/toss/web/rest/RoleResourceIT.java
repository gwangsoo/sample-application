...
class RoleResourceIT {
    ...
    private static final AuthScopeType DEFAULT_AUTH_SCOPE_TYPE = AuthScopeType.GLOBAL;
    private static final AuthScopeType UPDATED_AUTH_SCOPE_TYPE = AuthScopeType.COUNTRY;

    private static final AuthLevelType DEFAULT_AUTH_LEVEL_TYPE = AuthLevelType.WRITE;
    private static final AuthLevelType UPDATED_AUTH_LEVEL_TYPE = AuthLevelType.VIEW;
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role()
            .name(DEFAULT_NAME)
            .authScopeType(DEFAULT_AUTH_SCOPE_TYPE)
            .authLevelType(DEFAULT_AUTH_LEVEL_TYPE)
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role()
            .name(UPDATED_NAME)
            .authScopeType(UPDATED_AUTH_SCOPE_TYPE)
            .authLevelType(UPDATED_AUTH_LEVEL_TYPE)
    ...
    @Test
    @Transactional
    void checkAuthScopeTypeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        role.setAuthScopeType(null);
    ...
    @Test
    @Transactional
    void checkAuthLevelTypeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        role.setAuthLevelType(null);
    ...
    void getAllRoles() throws Exception {
        ...
        restRoleMockMvc
            ...
            .andExpect(jsonPath("$.[*].authScopeType").value(hasItem(DEFAULT_AUTH_SCOPE_TYPE.toString())))
            .andExpect(jsonPath("$.[*].authLevelType").value(hasItem(DEFAULT_AUTH_LEVEL_TYPE.toString())))
    ...
    void getRole() throws Exception {
        ...
        restRoleMockMvc
            ...
            .andExpect(jsonPath("$.authScopeType").value(DEFAULT_AUTH_SCOPE_TYPE.toString()))
            .andExpect(jsonPath("$.authLevelType").value(DEFAULT_AUTH_LEVEL_TYPE.toString()))
    ...
    void partialUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.name(UPDATED_NAME).authLevelType(UPDATED_AUTH_LEVEL_TYPE).displayOrder(UPDATED_DISPLAY_ORDER);
