...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.example.bff.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.example.bff.security.DomainUserDetailsService", "createSpringSecurityUser");
